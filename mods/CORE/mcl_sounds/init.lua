...
function mcla_sounds.node_sound_defaults(table)
	table = table or {}
...
function mcla_sounds.node_sound_stone_defaults(table)
	table = table or {}
	table.footstep = table.footstep or
	...
	mcla_sounds.node_sound_defaults(table)
	return table
end

function mcla_sounds.node_sound_metal_defaults(table)
	table = table or {}
	table.footstep = table.footstep or
...
function mcla_sounds.node_sound_dirt_defaults(table)
	table = table or {}
	table.footstep = table.footstep or
...
function mcla_sounds.node_sound_sand_defaults(table)
	table = table or {}
	table.footstep = table.footstep or
...
function mcla_sounds.node_sound_snow_defaults(table)
	table = table or {}
	table.footstep = table.footstep or
...
function mcla_sounds.node_sound_wood_defaults(table)
	table = table or {}
	table.footstep = table.footstep or
...
function mcla_sounds.node_sound_wool_defaults(table)
	table = table or {}
	table.footstep = table.footstep or
...
function mcla_sounds.node_sound_leaves_defaults(table)
	table = table or {}
	table.footstep = table.footstep or
...
function mcla_sounds.node_sound_glass_defaults(table)
	table = table or {}
	table.footstep = table.footstep or
...
function mcla_sounds.node_sound_water_defaults(table)
	table = table or {}
	table.footstep = table.footstep or
...
function mcla_sounds.node_sound_lava_defaults(table)
	table = table or {}
	-- TODO: Footstep
	table.place = table.place or
