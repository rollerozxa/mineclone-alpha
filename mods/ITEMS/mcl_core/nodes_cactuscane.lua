...
minetest.register_node(":mcla:cactus", {
	...
	tiles = {"mcla_core_cactus_top.png", "mcla_core_cactus_bottom.png", "mcla_core_cactus_side.png"},
...
minetest.register_node(":mcla:reeds", {
	...
	drawtype = "plantlike",
	tiles = {"mcla_core_papyrus.png"},
	inventory_image = "mcla_core_reeds.png",
	wield_image = "mcla_core_reeds.png",
	paramtype = "light",
	walkable = false,
	is_ground_content = true,
	node_box = {
